...
# The aim of this script is to create artifacts for further work:
# * database files
# * application files
...
docker build -t defectdojo -f Dockerfile.create . && docker run -it --rm -v $DBDIR:/var/lib/mysql -v $APPDIR:/opt/dojo -p 8000:8000 defectdojo

# Remove temporary image
docker image rm defectdojo
# ------------------------------------------------
